...
class Locales {
  ...
  static String howToConnectFirstPar = "There are many thousands of networks worldwide. Therefore, to log in to your existing network, you need the exact URL of your individual network.";
  ...
  static String moreInfoFirstPar = 'HumHub networks are basically closed communication platforms (internal to the organization). It is only possible to log into existing networks.';
